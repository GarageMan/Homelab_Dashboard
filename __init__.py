...
def load_options() -> dict:
    ...
    try:
        ...
        pass
    return {
        "ubuntu_host": os.getenv("UBUNTU_HOST", opts.get("ubuntu_host", "192.168.178.75")),
        "pihole_host": os.getenv("PIHOLE_HOST", opts.get("pihole_host", "192.168.178.5")),
...
def _mock():
    ...
    return {
        ...
        "ubuntu": {"ok": True, "label": "Ubuntu-Server", "host": "192.168.178.75",
        ...
        "pihole": {"ok": True, "host": "192.168.178.5", "blocking": "enabled", "queries": 93157,
                   "blocked": 18342, "percent": 19.7, "gravity": 151284, "clients_active": 12,
                   "top_blocked": "graph.facebook.com", "top_client": "192.168.178.31"},
